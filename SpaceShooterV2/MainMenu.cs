    ...
    internal class MainMenu
    {
        ...
        public void Draw(GameTime gameTime)
        {
            ...
            if (_curMenuState == MenuState.Options || _curMenuState == MenuState.SettingEntry)
            {
                ...
                _spriteBatch.DrawString(_font, "Up", new Vector2(_window.ClientBounds.Width / 2 - (_font.MeasureString("Up").X*_fontScale) / 2, _window.ClientBounds.Height / 1.5f - 4.6f * lineSpacing + (_font.MeasureString("Up").Y *_fontScale)/ 2), Color.White, 0f, new Vector2(0, 0), new Vector2(_fontScale, 1f), SpriteEffects.None, 0f);
                _spriteBatch.DrawString(_font, "Left", new Vector2(_window.ClientBounds.Width / 2 - (_font.MeasureString("Left").X * _fontScale) / 2, _window.ClientBounds.Height / 1.5f - 3.5f * lineSpacing + _font.MeasureString("Left").Y * _fontScale / 2), Color.White, 0f, new Vector2(0, 0), new Vector2(_fontScale, 1f), SpriteEffects.None, 0f);
                _spriteBatch.DrawString(_font, "Down", new Vector2(_window.ClientBounds.Width / 2 - (_font.MeasureString("Down").X * _fontScale) / 2, _window.ClientBounds.Height / 1.5f - 2.4f * lineSpacing + _font.MeasureString("Down").Y * _fontScale / 2), Color.White, 0f, new Vector2(0, 0), new Vector2(_fontScale, 1f), SpriteEffects.None, 0f);
                _spriteBatch.DrawString(_font, "Right", new Vector2(_window.ClientBounds.Width / 2 - (_font.MeasureString("Right").X * _fontScale) / 2, _window.ClientBounds.Height / 1.5f -  1.3f * lineSpacing + _font.MeasureString("Right").Y * _fontScale / 2), Color.White, 0f, new Vector2(0, 0), new Vector2(_fontScale, 1f), SpriteEffects.None, 0f);
                _spriteBatch.DrawString(_font, "Shoot", new Vector2(_window.ClientBounds.Width / 2 - (_font.MeasureString("Shoot").X * _fontScale) / 2, _window.ClientBounds.Height / 1.5f - _font.MeasureString("Shoot").Y * _fontScale / 2), Color.White, 0f, new Vector2(0, 0), new Vector2(_fontScale, 1f), SpriteEffects.None, 0f);
            }
            #endregion
